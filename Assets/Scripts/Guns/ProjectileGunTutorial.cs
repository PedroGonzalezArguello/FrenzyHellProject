...
public class ProjectileGunTutorial : MonoBehaviour
{
    ...
    private void MyInput()
    {
        ...
        if (allowButtonHold) shooting = Input.GetKeyDown(KeyCode.Q);
        else shooting = Input.GetKeyDown(KeyCode.Q);
    ...
    private void Shoot()
    {
        ...
        if (muzzleFlash != null)
        {
            ...
            Destroy(muzzleFlashInstance, 2f); // Destroy the explosion after 2 seconds
        }
